...
from data.load_data import convert_tsf_to_dataframe
from utils.data import upsample_timeseries, downsample_timeseries
        ...
        if timeseries_len <= self.seq_len:
            timeseries, input_mask =\
                upsample_timeseries(timeseries, 
                                    ...
                                    mode=self.pad_mode)
                                    #constant_values=self.pad_constant_values)
            # len_timeseries = self.seq_len - np.argmax(input_mask)
            # if len_timeseries%8 != 0:
            #     len_timeseries = 8 - len_timeseries%8 + len_timeseries
            # input_mask[-len_timeseries:] = 1
