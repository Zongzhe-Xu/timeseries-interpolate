...
class LongForecastingDataset(TaskDataset):
    ...
    def _get_borders(self):
        ...
        # Predefined splits for ETT datasets
        ...
        # This might need to be adjusted to reproduce certain results
        # elif 'illness' in self.dataset_name:
        #     print("You are overriding the split fraction paramter for the ILI (illness) dataset. This might not be necessary.")
        #     print("See external_ts/my_extract.py")
        #     n_train = 617
        #     n_val = 74
        #     n_test = 170
...
def get_timeseries_dataloaders(data_path: str, batch_size: int, seq_len=512, forecast_horizon=96, train_ratio=0.7, val_ratio=0.1, test_ratio=0.2):
    dataloaders = dict()
