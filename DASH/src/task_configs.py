...
import operator
from my_extract import get_timeseries_dataloaders
...
ts_file_dict = {
    "ETTh1": "./datasets/all_six_datasets/ETT-small/ETTh1.csv",
    "ETTh2": "./datasets/all_six_datasets/ETT-small/ETTh2.csv",
    "ETTm1": "./datasets/all_six_datasets/ETT-small/ETTm1.csv",
    "ETTm2": "./datasets/all_six_datasets/ETT-small/ETTm2.csv",
    "ECL": "./datasets/all_six_datasets/electricity/electricity.csv",
    "ER": "./datasets/all_six_datasets/exchange_rate/exchange_rate.csv",
    "ILI": "./datasets/all_six_datasets/illness/national_illness.csv",
    "Traffic": "./datasets/all_six_datasets/traffic/traffic.csv",
    "Weather": "./datasets/all_six_datasets/weather/weather.csv",
}
...
def get_data(dataset, batch_size, arch, valid_split):
    ...
    if len(params) > 1:
        ...
        if prefix in ts_file_dict:
            ...
            raise NotImplementedError(f"Prefix {prefix} not in ts file keys: {list(ts_file_dict.keys())}")
...
def get_config(dataset):
    ...
    params = dataset.split("_")
    if params[0] in ts_file_dict: # modify this to experiment with a new task
        horizon = int(params[1])
